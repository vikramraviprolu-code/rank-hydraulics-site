...
- The source appointment form points to FormSubmit on the home page and a placeholder script URL on the contact page. The rebuild uses a static `mailto:` flow so the project remains standalone.
